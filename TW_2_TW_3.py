...
class TW_vers_2_3():
    ...
    def pos_twin(self, a, at,b,bt,e, x,xt,y,yt, z):
        """
        Index of the probability matrix P for P(aa'bb'ee'|x'yy'zz').
    ...
    def get_P_twin(self, P_twin, problem):
        """
        Applies the symmetry condition on Ptwin: \sum_e p(aa'bb'e|xx'yy'z) is symmetric under the exchange (a,x)<->(a',x'), (b,y)<->(b',y')
    
        Parameters
        ----------
        P_twin : pc.RealVariable
            Probability distribution twin world
        problem : pc.Problem
    ...
    def constrain_BR2_vers2(self,P_twin, problem):
        """
        Adds constrains to P such that 
         - P(aa'b'e|xx'yy'z = (x,y)) = 0 if e != (a,b) forall aa'bb' xx'yy'
         - P(aa'b'e|xx'yy'z = (x',y')) = 0 if e != (a',b') forall aa'bb' xx'yy'
         - P(aa'b'e|xx'yy'z = (x',y)) = 0 if e != (a',b) forall aa'bb' xx'yy'
         - P(aa'b'e|xx'yy'z = (x,y')) = 0 if e != (a,b') forall aa'bb' xx'yy'
        ...
        ----------
        P_twin : pc.RealVariable
            Probability distribution of twin world.
        problem : pc.Problem
        Returns
        -------
        none
    ...
    def solve_CHSH(self):
        ...
        -------
        P_twin: pc.RealVariable
            Matrix with the prob distr of TW
        P_ab: pc.RealVariable
            Matrix with the prob distr of p(ab|xy)
        P: pc.RealVariable
            Matrix with the prob distr of p(abe|xyz)
        """
